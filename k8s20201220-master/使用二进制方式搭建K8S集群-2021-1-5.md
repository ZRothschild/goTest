...
# 在master添加hosts
cat >> /etc/hosts << EOF
192.168.56.138    master-10
192.168.56.139    node-10
192.168.56.140    node-11
EOF
...
ETCD_INITIAL_CLUSTER="etcd-1=https://192.168.56.138:2380,etcd-2=https://192.168.56.139:2380,etcd-3=https://192.168.56.140:2380"
...
~~~shell
# sudo ETCDCTL_API=3 /opt/etcd/bin/etcdctl --cacert=/opt/etcd/ssl/ca.pem --cert=/opt/etcd/ssl/server.pem --key=/opt/etcd/ssl/server-key.pem --endpoints="https://192.168.56.138:2379,https://192.168.56.139:2379,https://192.168.56.140:2379" endpoint status --write-out=table
# sudo ETCDCTL_API=3 /opt/etcd/bin/etcdctl --cacert=/opt/etcd/ssl/ca.pem --cert=/opt/etcd/ssl/server.pem --key=/opt/etcd/ssl/server-key.pem --endpoints="https://192.168.56.138:2379,https://192.168.56.139:2379,https://192.168.56.140:2379" get /test/testkey

[root@k8s-node171 ~]# sudo ETCDCTL_API=3 /opt/etcd/bin/etcdctl --cacert=/opt/etcd/ssl/ca.pem --cert=/opt/etcd/ssl/server.pem --key=/opt/etcd/ssl/server-key.pem --endpoints="https://192.168.56.138:2379,https://192.168.56.139:2379,https://192.168.56.140:2379" endpoint health
...
--etcd-servers=https://192.168.56.138:2379,https://192.168.56.139:2379,https://192.168.56.140:2379 \\
--bind-address=192.168.56.138 \\
--secure-port=6443 \\
--advertise-address=192.168.56.138 \\
...
35f55b9be7663bfe47b3d709f8ece62c
cat > /opt/kubernetes/cfg/token.csv << EOF
35f55b9be7663bfe47b3d709f8ece62c,kubelet-bootstrap,10001,"system:node-bootstrapper"
EOF
...
## clusterrolebinding.rbac.authorization.k8s.io/kubelet-bootstrap 
...
~~~shell
[root@k8s-master170 kubernetes]#  sudo bash -c "cat > /etc/hosts" <<EOF
...
~~~shell
KUBE_APISERVER="https://192.168.56.138:6443" # apiserver IP:PORT
TOKEN="35f55b9be7663bfe47b3d709f8ece62c" # 与token.csv里保持一致
