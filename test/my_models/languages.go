...
func (o *Language) AddPilotsG(ctx context.Context, insert bool, related ...*Pilot) error {
	return o.AddPilots(ctx, boil.GetContextDB(), insert, related...)
}
...
// Uses the global database handle.
func (o *Language) SetPilotsG(ctx context.Context, insert bool, related ...*Pilot) error {
	return o.SetPilots(ctx, boil.GetContextDB(), insert, related...)
}
...
// Uses the global database handle.
func (o *Language) RemovePilotsG(ctx context.Context, related ...*Pilot) error {
	return o.RemovePilots(ctx, boil.GetContextDB(), related...)
}
...
func FindLanguageG(ctx context.Context, iD int, selectCols ...string) (*Language, error) {
...
func LanguageExistsG(ctx context.Context, iD int) (bool, error) {
