...
func (q pilotQuery) OneG(ctx context.Context) (*Pilot, error) {
...
func (q pilotQuery) AllG(ctx context.Context) (PilotSlice, error) {
...
func (q pilotQuery) CountG(ctx context.Context) (int64, error) {
...
func (q pilotQuery) ExistsG(ctx context.Context) (bool, error) {
...
func (o *Pilot) AddJetsG(ctx context.Context, insert bool, related ...*Jet) error {
	return o.AddJets(ctx, boil.GetContextDB(), insert, related...)
}
...
// Uses the global database handle.
func (o *Pilot) AddLanguagesG(ctx context.Context, insert bool, related ...*Language) error {
	return o.AddLanguages(ctx, boil.GetContextDB(), insert, related...)
}
...
// Uses the global database handle.
func (o *Pilot) SetLanguagesG(ctx context.Context, insert bool, related ...*Language) error {
	return o.SetLanguages(ctx, boil.GetContextDB(), insert, related...)
}
...
// Uses the global database handle.
func (o *Pilot) RemoveLanguagesG(ctx context.Context, related ...*Language) error {
	return o.RemoveLanguages(ctx, boil.GetContextDB(), related...)
}
...
func FindPilotG(ctx context.Context, iD int, selectCols ...string) (*Pilot, error) {
	return FindPilot(ctx, boil.GetContextDB(), iD, selectCols...)
}
...
func (o *Pilot) InsertG(ctx context.Context, columns boil.Columns) error {
...
func (o *Pilot) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
...
func (q pilotQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
// UpdateAllG updates all rows with the specified column values.
func (o PilotSlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o *Pilot) UpsertG(ctx context.Context, updateColumns, insertColumns boil.Columns) error {
...
func (o *Pilot) DeleteG(ctx context.Context) (int64, error) {
...
func (q pilotQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o PilotSlice) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o *Pilot) ReloadG(ctx context.Context) error {
	if o == nil {
...
func (o *PilotSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
...
func PilotExistsG(ctx context.Context, iD int) (bool, error) {
	return PilotExists(ctx, boil.GetContextDB(), iD)
}
