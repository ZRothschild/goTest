...
func (q jetQuery) OneG(ctx context.Context) (*Jet, error) {
...
func (q jetQuery) AllG(ctx context.Context) (JetSlice, error) {
...
func (q jetQuery) CountG(ctx context.Context) (int64, error) {
...
func (q jetQuery) ExistsG(ctx context.Context) (bool, error) {
...
func (o *Jet) SetPilotG(ctx context.Context, insert bool, related *Pilot) error {
	return o.SetPilot(ctx, boil.GetContextDB(), insert, related)
}
...
func FindJetG(ctx context.Context, iD int, selectCols ...string) (*Jet, error) {
	return FindJet(ctx, boil.GetContextDB(), iD, selectCols...)
}
...
func (o *Jet) InsertG(ctx context.Context, columns boil.Columns) error {
...
func (o *Jet) UpdateG(ctx context.Context, columns boil.Columns) (int64, error) {
...
func (q jetQuery) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
// UpdateAllG updates all rows with the specified column values.
func (o JetSlice) UpdateAllG(ctx context.Context, cols M) (int64, error) {
...
func (o *Jet) UpsertG(ctx context.Context, updateColumns, insertColumns boil.Columns) error {
...
func (o *Jet) DeleteG(ctx context.Context) (int64, error) {
...
func (q jetQuery) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o JetSlice) DeleteAllG(ctx context.Context) (int64, error) {
...
func (o *Jet) ReloadG(ctx context.Context) error {
	if o == nil {
...
func (o *JetSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
...
func JetExistsG(ctx context.Context, iD int) (bool, error) {
	return JetExists(ctx, boil.GetContextDB(), iD)
}
