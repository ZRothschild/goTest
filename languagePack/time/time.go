...
func main() {
	...
	*/
	...
	checkThree := time.Unix(checkTwo.Unix(), 0).Format("2006/01/02 15:04:05.999999999")
	...
	*/
	...
	t := time.Date(0, 0, 0, 14, 15, 30, 918273645, time.UTC)
	round := []time.Duration{
		time.Nanosecond,
		time.Microsecond,
		time.Millisecond,
	...
	//t.Round(   1ns) = 14:15:30.918273645
	//t.Round(   1µs) = 14:15:30.918274
	//t.Round(   1ms) = 14:15:30.918
	//t.Round(    1s) = 14:15:31
	//t.Round(    2s) = 14:15:30
	//t.Round(  1m0s) = 14:16:00
	//t.Round( 10m0s) = 14:20:00
